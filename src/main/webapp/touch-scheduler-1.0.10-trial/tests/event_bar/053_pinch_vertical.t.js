StartTest(function (t) {
    ...
    t.waitForEventsVisible(function () {
        ...
        pinchFeature.onPinchStart(scheduler, taskRecord, eventNode, { touches : [
            { pageX : elBox.left, pageY : elBox.top },
            { pageX : elBox.right, pageY : elBox.bottom }
        ] });

        pinchFeature.onPinch({ touches : [
            { pageX : elBox.left, pageY : elBox.top },
            { pageX : elBox.right, pageY : elBox.bottom + tickWidth }
        ] });

        pinchFeature.onPinchEnd(scheduler, taskRecord, eventNode, { touches : [
            {pageX : elBox.left, pageY : elBox.top },
            { pageX : elBox.right, pageY : elBox.bottom  + tickWidth}
        ] });
        ...
        pinchFeature.onPinchStart(scheduler, taskRecord, eventNode, { touches : [
            {pageX : elBox.left, pageY : elBox.top },
            { pageX : elBox.right, pageY : elBox.top }
        ] });

        pinchFeature.onPinch({ touches : [
            {pageX : elBox.left, pageY : elBox.top },
            { pageX : elBox.right, pageY : elBox.top  + 20000}
        ] });
