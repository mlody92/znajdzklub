...
Ext.define("Sch.plugin.CurrentTimeLine", {
    ...
    init                : function(cmp) {
        ...
        // HACK TODO: Listening to 'destroy' method of Component isn't reliable
        // This is guarded by the test 314_memory.t.js which fails if using the regular cmp.on(...) approach
        // This branch should be removed when supporting Ext JS 6 modern
        if (Ext.versions.touch) {
            var destr = cmp.destroy;
            var me = this;
